        ...
        for listing_doc in listings:
            ...
            if "image_ids" in serialized_doc and isinstance(serialized_doc["image_ids"], list):
                for img_id in serialized_doc["image_ids"]:
                    ...
                    if listing_id_str:
                        full_image_urls.append(f"{os.getenv('NEXT_PUBLIC_API_BASE_URL')}/api/listings/{listing_id_str}/images/{img_id}")
                    else:
        ...
        for order_doc in orders:
            ...
            if product_listing and product_listing.get("image_ids"):
                ...
                if first_image_id_str:
                    ...
                    product_image_url = f"{os.getenv('NEXT_PUBLIC_API_BASE_URL')}/api/listings/{listing_id_str}/images/{first_image_id_str}"
