        ...
        <div className="container mx-auto px-4 py-20 relative">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="relative max-w-4xl mx-auto">
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-orange-200/50">
                  <div className="aspect-video bg-gradient-to-br from-amber-100 via-orange-100 to-rose-100 rounded-2xl flex items-center justify-center relative overflow-hidden cursor-pointer group" onClick={handlePlay} tabIndex={0} role="button" aria-label="Play KalaMitra Demo Video">
                    <div className="absolute inset-0 bg-gradient-to-r from-amber-500/10 to-rose-500/10"></div>
                  ...
                  {showVideo && (
                    <div className="absolute inset-0 z-30 flex items-center justify-center rounded-3xl overflow-hidden">
                      <div className="relative w-full h-full">
                        ...
                        <video
                          src="/videos/Screen%20Recording%202025-03-28%20151333.mp4"
                          controls
                          autoPlay
