...
export default function Home() {
  ...
  // If authenticated, redirect to appropriate dashboard or show LandingPage
  if (user && role) {
    redirect(role === "artisan" ? "/auth/artisan" : "/auth/buyer");
  }

  // Show LandingPage for unauthenticated users or initial load
  return <LandingPage />;
}

function LandingPage() {
  // Current date and time (02:17 PM IST, Sunday, July 13, 2025)
  const currentDate = new Date("2025-07-13T14:17:00+05:30");
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-300">
                <li>
                  <Link href="/auth/artisan" className="hover:text-orange-400 transition-colors">
                    Get Started
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 KalaMitra. Made with ❤️ for Indian artisans and craft lovers worldwide. Last updated: {formattedDate}
            </p>
          </div>
        </div>
      </footer>
